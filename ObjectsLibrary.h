...
namespace ObjectsLibrary
{
	...
	//public:
	//	// Returns a + b   
	//	static OBJECTSLIBRARY_API double Add(double a, double b);

	//	// Returns a * b   
	//	static OBJECTSLIBRARY_API double Multiply(double a, double b);

	//	// Returns a + (a * b)   
	//	static OBJECTSLIBRARY_API double AddMultiply(double a, double b);
	//};
